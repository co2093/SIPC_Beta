...
@section('content')
	...
	<nav aria-label="breadcrumb">
	  <ol class="breadcrumb">
	    ...
	    <li class="breadcrumb-item"><a href="{{ route('actividades.show') }}">Ver tipos de actividades</a></li>
        ...
        <div class="col-lg-12">
  	        <div class="card shadow mb-4">
  	        	    ...
  	        	    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-dark">Crear tipo de actividad</h6>
                    </div>
