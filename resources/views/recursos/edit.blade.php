        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('recursos.update') }}" accept-charset="UTF-8" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="idproyecto" value="{{ $recurso->idproyecto }}">
                    <input type="hidden" name="idrecurso" value="{{ $recurso->idrecurso }}">
                    <input type="hidden" name="fuenteanterior" value="{{ $recurso->idfuente }}">

                    <div class="form-group">
                        <label for="exampleFormControlSelect1">Actividad asociada</label>
                        <select class="form-control" name="idactividad" required>
                            <option value="{{ $recurso->idactividad }}">{{ $recurso->nombreactividad }}</option>
                            @foreach($actividades as $a)
                                @if($a->idactividad != $recurso->idactividad)
        ...
        <div class="row">
            <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nombre" value="{{ $recurso->nombrerecurso }}"required>
                      </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="cantidad" value="{{ $recurso->cantidadrecurso }}" min="1" required>
                </div>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="number" class="form-control" name="montofuente" id="montofuente" value="{{ $recurso->montofuente }}"  min="0.0" step="0.01" value="0.0"
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="number" class="form-control" name="montoconvocatoria" id="montoconvocatoria" min="0.0" step="0.01" value="0.0"
                  value="{{ $recurso->montoconvocatoria }}" max="" onkeypress="return event.charCode == 46 || (event.charCode >= 48 && event.charCode <= 57)" required>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
