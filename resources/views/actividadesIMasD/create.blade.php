...
<form action="/actividadesIMasD" method="post" style="margin: 25px;">
  @csrf
  <div class="form-container d-flex flex-column ">
    <div class="tab-content" id="myTabContent">
      <div class="d-flex justify-content-between" style="margin-bottom: 10px;">
        ...
        <input type="text" class="form-control ml-3 @error('nombre_actividad') is-invalid @enderror" tabindex="1" id="nombre_actividad" name="nombre_actividad" placeholder="{{ $errors->has('nombre_actividad') ? $errors->first('nombre_actividad') : 'Ingrese el nombre de la actividad' }}" value="{{ old('nombre_actividad') }}">
        ...
        <input type="text" class="form-control  @error('descripcion_actividad') is-invalid @enderror" tabindex="1" id="descripcion_actividad" name="descripcion_actividad" placeholder="{{ $errors->has('descripcion_actividad') ? $errors->first('descripcion_actividad') : 'Ingrese la descripcion de la actividad' }}" value="{{ old('descripcion_actividad') }}">
      </div>
    </div>
  </div>
  <div class="form-container d-flex flex-column ">
