...
<form action="/investigadores/{{$investigador->id_invest}}" method="post" style="margin: 25px;">
  ...
  <div class="form-container d-flex flex-column ">
    <div class="d-flex justify-content-between" style="margin-bottom: 10px;">
      ...
      <input type="text" class="form-control w-75" tabindex="1" id="nombre_persona" name="nombre_persona" value="{{$investigador->personasInvestigadores->nombre_persona}}">
    </div>

    <div class="d-flex justify-content-between" style="margin-bottom: 10px;">
      <label for="" class="form-label me-3" style="margin-right: 10px;">Apellidos</label>
      <input type="text" class="form-control w-75" tabindex="2" id="apellido_persona" name="apellido_persona" value="{{$investigador->personasInvestigadores->apellido_persona}}">
    </div>

    <div class="d-flex justify-content-between" style="margin-bottom: 10px;">
      <label for="" class="form-label me-3" style="margin-right: 10px;">Correo Electr&oacute;nico</label>
      <input type="email" class="form-control w-75" tabindex="3" name="correo_persona" id="correo_persona" value="{{$investigador->personasInvestigadores->correo_persona}}">
    </div>
    <div class="d-flex justify-content-between" style="margin-bottom: 10px;">
