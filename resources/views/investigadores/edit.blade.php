    ...
    <div class="tab-content" id="myTabContent">
      ...
      <div class="tab-pane fade show active mt-5" id="personal" role="tabpanel" aria-labelledby="personal-tab">
        <div class="d-flex justify-content-between" style="margin-bottom: 10px;">
          ...
          <input type="text" class="form-control  @error('apellido_persona') is-invalid @enderror" tabindex="2" id="apellido_persona" name="apellido_persona" placeholder="{{ $errors->has('apellido_persona') ? $errors->first('apellido_persona') : 'Ingrese Apellidos' }}" value="{{$investigador->personasInvestigadores->apellido_persona}}">
        </div>
        <div class="d-flex justify-content-between" style="margin-bottom: 10px;">
          ...
          <input type="email" class="form-control  @error('correo_persona') is-invalid @enderror" tabindex="3" name="correo_persona" id="correo_persona" placeholder="{{ $errors->has('correo_persona') ? $errors->first('correo_persona') : 'Ingrese el Correo Electrónico' }}" value="{{$investigador->personasInvestigadores->correo_persona}}">
        </div>
        <div class="d-flex justify-content-between" style="margin-bottom: 10px;">
          ...
          <input type="text" class="form-control  @error('telefono_persona') is-invalid @enderror" tabindex="4" id="telefono_persona" name="telefono_persona" placeholder="{{ $errors->has('telefono_persona') ? $errors->first('telefono_persona') : 'Ingrese Telefono' }}" value="{{$investigador->personasInvestigadores->telefono_persona}}">
          ...
          <input type="number" class="form-control @error('edad_persona') is-invalid @enderror" tabindex="5" id="edad_persona" name="edad_persona" placeholder="{{ $errors->has('edad_persona') ? $errors->first('edad_persona') : 'Ingrese la edad' }}" value="{{$investigador->personasInvestigadores->edad_persona}}">
        </div>
        <div class="d-flex justify-content-between" style="margin-bottom: 10px;">
          ...
          <input type="text" class="form-control  @error('direccion_persona') is-invalid @enderror" tabindex="6" name="direccion_persona" id="direccion_persona" placeholder="{{ $errors->has('direccion_persona') ? $errors->first('direccion_persona') : 'Ingrese lugar de residencia del Investigador' }}" value="{{$investigador->personasInvestigadores->direccion_persona}}">
        </div>
        <div class="d-flex justify-content-between" style="margin-bottom: 10px;">
