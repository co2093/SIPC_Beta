  ...
  <ul class="nav nav-tabs" id="myTab" role="tablist">
    <li class="nav-item" role="presentation">
      <button class="nav-link active" id="personal-tab" data-bs-toggle="tab" data-bs-target="#personal" type="button"
        role="tab" aria-controls="personal" aria-selected="true">Datos Personales</button>
    </li>
    <li class="nav-item" role="presentation">
      <button class="nav-link" id="academic-tab" data-bs-toggle="tab" data-bs-target="#academic" type="button"
        role="tab" aria-controls="academic" aria-selected="false">Datos Acad&eacute;micos</button>
    </li>
  </ul>
    ...
    <div class="tab-content" id="myTabContent">
      ...
      <div class="tab-pane fade show active mt-5" id="personal" role="tabpanel" aria-labelledby="personal-tab">
        <div class="d-flex justify-content-between" style="margin-bottom: 10px;">
          ...
          <input type="text" class="form-control  @error('nombre_persona') is-invalid @enderror" tabindex="1"
            ...
            value="{{$investigador->personasInvestigadores->nombre_persona}}">
          ...
          <input type="text" class="form-control  @error('apellido_persona') is-invalid @enderror" tabindex="2"
            ...
            value="{{$investigador->personasInvestigadores->apellido_persona}}">
        </div>
        <div class="d-flex justify-content-between" style="margin-bottom: 10px;">
          ...
          <input type="email" class="form-control  @error('correo_persona') is-invalid @enderror" tabindex="3"
            ...
            value="{{$investigador->personasInvestigadores->correo_persona}}">
        </div>
        <div class="d-flex justify-content-between" style="margin-bottom: 10px;">
        ...
        <div class="d-flex justify-content-between" style="margin-bottom: 10px;">
          ...
          <input type="text" class="form-control  @error('direccion_persona') is-invalid @enderror" tabindex="6"
            ...
            value="{{$investigador->personasInvestigadores->direccion_persona}}">
        </div>
        <div class="d-flex justify-content-between" style="margin-bottom: 10px;">
      ...
      <div class="tab-pane fade mt-5" id="academic" role="tabpanel" aria-labelledby="academic-tab">
        ...
        <div class="d-flex justify-content-between" style="margin-bottom: 25px;">
          ...
          <select class="form-control ml-2 @error('id_cap') is-invalid @enderror" tabindex="5" name="id_cap"
            id="id_cap">
        ...
        <div class="d-flex justify-content-between" style="margin-bottom: 10px;">
          ...
          <select class="form-control ml-5 @error('id_unidad_rrhh') is-invalid @enderror" tabindex="5"
            name="id_unidad_rrhh" id="id_unidad_rrhh">
            @foreach ($rrhh as $rh)
